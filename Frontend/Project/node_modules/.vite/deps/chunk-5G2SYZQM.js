...
var Dialog = React4.forwardRef(function Dialog2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React4.useRef();
  ...
  const dialogContextValue = React4.useMemo(() => {
    return {
...
var DialogActions = React5.forwardRef(function DialogActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialogActions"
  });
...
var DialogContent = React6.forwardRef(function DialogContent2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialogContent"
  });
...
var ListItemButton = React8.forwardRef(function ListItemButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemButton"
  });
  ...
  return (0, import_jsx_runtime9.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime9.jsx)(ListItemButtonRoot, _extends({
      ref: handleRef,
...
var ListItemSecondaryAction = React9.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsx)(ListItemSecondaryActionRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var ListItem = React10.forwardRef(function ListItem2(inProps, ref) {
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime11.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime12.jsxs)(ListItemContainer, _extends({
        as: ContainerComponent,
        className: clsx_default(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState
      }, ContainerProps, {
        children: [(0, import_jsx_runtime11.jsx)(Root, _extends({}, rootProps, !isHostComponent_default(Root) && {
          as: Component,
  ...
  return (0, import_jsx_runtime11.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime12.jsxs)(Root, _extends({}, rootProps, {
      as: Component,
      ref: handleRef
    }, !isHostComponent_default(Root) && {
      ownerState: _extends({}, ownerState, rootProps.ownerState)
    }, componentProps, {
      children: [children, secondaryAction && (0, import_jsx_runtime11.jsx)(ListItemSecondaryAction_default, {
...
var _excluded9 = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
...
var Tab = React11.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React11.isValidElement(iconProp) ? React11.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime13.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime13.jsxs)(React11.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime13.jsxs)(React11.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
true ? Tab.propTypes = {
   ...
   * The icon to display.
   */
  icon: import_prop_types9.default.oneOfType([import_prop_types9.default.element, import_prop_types9.default.string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: import_prop_types9.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * The label element.
   */
   ...
   * @default false
   */
  wrapped: import_prop_types9.default.bool
} : void 0;
var Tab_default = Tab;
...
var _excluded10 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
var TabScrollButton = React14.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime16.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime16.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
var _excluded12 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
...
var Tabs = React16.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React16.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React16.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React16.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React16.useState(false);
  const [scrollerStyle, setScrollerStyle] = React16.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React16.useRef(null);
  const tabListRef = React16.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React16.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime18.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime18.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime18.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime18.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
    className: clsx_default(classes.indicator, TabIndicatorProps.className),
    ownerState,
    style: _extends({}, indicatorStyle, TabIndicatorProps.style)
  }));
  let childIndex = 0;
  const children = React16.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React16.cloneElement(child, _extends({
  ...
  return (0, import_jsx_runtime19.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime19.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime18.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types12.default.bool,
  /**
   ...
   * @default false
   */
  centered: import_prop_types12.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types12.default.oneOfType([import_prop_types12.default.oneOf(["primary", "secondary"]), import_prop_types12.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types12.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types12.default.oneOf(["auto", false, true]),
  /**
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types12.default.object,
  /**
   * Props applied to the [`TabScrollButton`](/material-ui/api/tab-scroll-button/) element.
   * @default {}
   */
  TabScrollButtonProps: import_prop_types12.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types12.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types12.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types12.default.bool
} : void 0;
...
//# sourceMappingURL=chunk-5G2SYZQM.js.map
